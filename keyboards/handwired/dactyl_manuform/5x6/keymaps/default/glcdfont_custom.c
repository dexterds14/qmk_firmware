...
/**
 * Trimmed QMK 6x8 font covering only ASCII 0x20 (space) through 0x5A ('Z'),
 * which is everything oled_task_user() displays. Derived from
 * drivers/oled/glcdfont.c. Requires in config.h:
 *   OLED_FONT_START 32, OLED_FONT_END 90
 */
