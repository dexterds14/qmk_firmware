const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi_89(
        ...
        _______, LSFT(KC_TAB), LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_B), BAT_LVL, LCTL(KC_N), LALT(KC_ENTER), QK_USER_0, QK_USER_1, LCTL(KC_SLASH), KC_PAGE_DOWN, _______,
    ...
    [5] = LAYOUT_ansi_89(
        ...
        _______, XXXXXXX, LSFT(LCTL(KC_Z)), XXXXXXX, LSFT(LCTL(KC_C)), LSFT(LCTL(KC_V)), XXXXXXX, BAT_LVL, LSFT(LCTL(KC_N)), XXXXXXX, XXXXXXX, QK_USER_0, XXXXXXX, XXXXXXX, _______,
